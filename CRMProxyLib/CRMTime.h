...
@property (nonatomic, strong) CRMOptionSet* sonoma_invoicetype;
...
@property (nonatomic, strong) CRMOptionSet* sonoma_source;
...
@property (nonatomic, strong) CRMOptionSet* statecode;
@property (nonatomic, strong) CRMOptionSet* statuscode;

...
@property (nonatomic, strong) OptionSet* sonoma_invoicetype;
...
@property (nonatomic, strong) OptionSet* sonoma_source;
...
@property (nonatomic, strong) OptionSet* statecode;
@property (nonatomic, strong) OptionSet* statuscode;
